  ...
  render() {
    return (
      <svg version="1.1" viewBox="0 0 1186.8 666.8" >
        <a onClick={() => this.props.handleClick('PRO')}> 
          <g id="PRO">
        ...
        <a onClick={() => this.props.handleClick('OPS')}> 
          <g id="OPS">
        ...
        <a onClick={() => this.props.handleClick('SECURITE')}> 
          <g id="SECURITE">
        ...
        <a onClick={() => this.props.handleClick('EXPLOIT')}> 
          <g id="EXPLOIT">
        ...
        <a onClick={() => this.props.handleClick('SI')}> 
          <g id="SI">
        ...
        <a onClick={() => this.props.handleClick('DATA')}> 
          <g id="DATA">
        ...
        <a onClick={() => this.props.handleClick('IA')}> 
          <g id="IA">
        ...
        <a onClick={() => this.props.handleClick('DEV')}> 
          <g id="DEV">
