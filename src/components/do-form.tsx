...
class DoForm extends React.Component<IProps, IState> {
  ...
  render() {
    return (
      <svg version="1.1" viewBox="0 0 1186.8 666.8" >
        <a onClick={() => this.changeActiveElement('PRO')}> 
          <g id="PRO">
            <path className="st0" d="M593.4,539.7c5.9-8.6,12-17.1,17.7-25.9c23.8-36.7,40.1-77.9,47.8-121c2.3-12.6,3.4-25.3,4.9-37.9
            ...
            <path className="st1" d="M647.7,512.6l-5-5.9l-10.5,9l-6.6-7.7l35.2-30l12.3,14.4c7.2,8.4,6.5,17.7-0.7,23.8l-0.1,0.1
            ...
            <path className="st1" d="M680.5,562.3l1.5-17.7l-6.2-5l-9.3,11.5l-7.9-6.4l29-36L704,522c8.5,6.8,10,15.4,4,22.8l-0.1,0.1
            ...
            <path className="st1" d="M722.3,588.1c-12.9-6-17.8-19.9-12.2-31.8l0.1-0.1c5.5-11.9,19.4-17.3,32.4-11.3s17.8,19.9,12.3,31.8l-0.1,0.1
        ...
        <a onClick={() => this.changeActiveElement('OPS')}> 
          <g id="OPS">
            <path  className="st2" d="M593.4,539.7c-6.4,7.2-12.5,14.7-19.2,21.7c-49.7,52.2-109.8,85.7-180.7,99.4c-20.6,3.9-41.6,5.9-62.5,6
            ...
            <path className="st1" d="M495.4,562.5c-13.9,8.4-30,4.1-37.8-8.6l-0.1-0.1c-7.8-12.8-4-29.3,9.8-37.7s30-4.1,37.8,8.6l0.1,0.1
            ...
            <path className="st1" d="M535.9,510.1l-6.3,6.1l11,11.3l-8.3,8.1l-36.6-37.6l15.4-15c9-8.7,19.6-8.7,27.1-1l0.1,0.1
              ...
              L529.9,490.3z"/>
            <path className="st1" d="M582.7,479.1c-4.5,6.8-11.4,11.8-19.4,13.9l-3-10.2c5.9-1.8,10.7-4.5,14-9.5c2.6-3.9,2.6-7.4,0.1-9l-0.1-0.1
        ...
        <a onClick={() => this.changeActiveElement('SECURITE')}> 
          <g id="SECURITE">
            <path className="st3" d="M1040.3,373.2c15.2,10.2,29.8,20.1,44.3,30c4.7,3.2,9.6,6.1,14,9.6c3.7,3,7.6,3.4,12.1,2.7
            ...
            <path className="st1" d="M835.3,616.8c-7.2,0.1-14.2-2.4-19.7-7.1l5.9-7.3c4.2,3.4,8.6,5.5,13.9,5.4c4.2-0.1,6.6-1.8,6.6-4.5v-0.1
            ...
            <path className="st1" d="M863.5,615.2l-4.6-46l34.7-3.4l0.9,9l-24.6,2.4l0.9,9.3l21.7-2.1l0.9,9l-21.7,2.2l1,9.7l25-2.5l0.9,9
		          L863.5,615.2z"/>
            <path className="st1" d="M931.9,606.4c-12.6,2.9-25.1-5-27.9-17.6c-0.1-0.3-0.1-0.5-0.2-0.8v-0.1c-2.7-12.8,4.8-25.4,18.7-28.3
            ...
            <path className="st1" d="M980.5,592.3c-11.6,4.3-21.2,0.4-25.9-12.3l-9.2-24.8l9.5-3.5l9,24.5c2.6,7.1,7.5,9.4,13.3,7.3s8-7,5.5-13.9
		          l-9.2-24.8l9.5-3.5l9,24.5C997.1,578.8,992.1,588,980.5,592.3z"/>
            <path className="st1" d="M1037.6,562.9l-16.2-7.4l-6.8,4.2l7.7,12.6l-8.7,5.3l-24.1-39.4l18-11c9.3-5.7,17.9-4.2,22.8,3.9l0.1,0.1
            ...
            <path className="st1" d="M1057.8,547.5l-30.4-34.8l7.7-6.7l30.4,34.8L1057.8,547.5z"/>
            <path className="st1" d="M1060.2,489.7l29.8,21.6l-6,8.2l-29.8-21.6l-8.2,11.4l-7.6-5.5l22.5-31l7.6,5.5L1060.2,489.7z"/>
            <path className="st1" d="M1103.9,490l-40.5-22.3l16.8-30.5l7.9,4.4l-11.9,21.7l8.2,4.5l10.5-19.1l7.9,4.4l-10.5,19.1l8.5,4.7l12.1-22
		          l7.9,4.4L1103.9,490z"/>
          </g>
        </a>
        
        <a onClick={() => this.changeActiveElement('EXPLOIT')}> 
          <g id="EXPLOIT">
            <path className="st4" d="M1186.8,333.7c0.2,17.7-1.8,35.2-4.1,52.7c-0.5,3.6-1.8,5.2-5.8,5.7c-22.4,3.1-44.8,6.5-67.1,10
            ...
            <path className="st1" d="M970.6,107.4l32.7-32.6l24.6,24.7l-6.4,6.4L1004,88.3l-6.6,6.7l15.4,15.4l-6.4,6.4L991,101.3l-6.9,6.8
		          l17.7,17.8l-6.4,6.4L970.6,107.4z"/>
            <path className="st1" d="M1019.6,160.3l5.4-18.1l-18.8,2.3l-7.5-8.8l28.3-2.9l7.4-26.4l7.7,9.1l-5.2,17.1l17.7-2.2l7.5,8.8l-27.2,2.8
		          l-7.7,27.6L1019.6,160.3z"/>
            <path className="st1" d="M1052.7,181.5l-4.4-6.3l-11.4,7.9l-5.8-8.3l37.9-26.4l10.8,15.5c6.3,9,4.7,18.2-3,23.6l-0.1,0.1
            ...
            <path className="st1" d="M1055.2,210.3l40.4-22.4l4.9,8.9l-32.3,17.9l11.2,20.2l-8.1,4.5L1055.2,210.3z"/>
            <path className="st1" d="M1080.5,263.6c-5.2-13.3,1-26.7,13.2-31.5l0.1-0.1c12.2-4.8,26,0.9,31.2,14.2c5.2,13.3-1,26.7-13.2,31.5
            ...
            <path className="st1" d="M1092.2,294.7l44.2-13.5l3,9.7l-44.2,13.5L1092.2,294.7z"/>
            <path className="st1" d="M1139.3,326.1l-35.7,9.2l-2.5-9.8l35.7-9.2l-3.5-13.6l9.1-2.3l9.5,37.1l-9.1,2.3L1139.3,326.1z"/>
          </g>
        </a>

        <a onClick={() => this.changeActiveElement('SI')}> 
          <g id="SI">
            <path className="st5" d="M142.8,328.7c-0.3,19.2,1.6,37.6,7.3,55.3c23.7,74.1,73.6,119.3,149.9,134.5c9.6,1.9,14.6,5.1,17.7,14.5
            ...
            <path className="st1" d="M114,529.2c-6.9-8-10.4-18.3-9.8-28.8l14-0.7c-0.1,8,1.5,14.9,6.4,20.7c3.9,4.5,8.2,5.6,11.4,2.9l0.1-0.1
            ...
            <path className="st1" d="M145.4,560.1l46.9-53.7l11,9.6l-46.9,53.7L145.4,560.1z"/>
          </g>
        </a>
        
        <a onClick={() => this.changeActiveElement('DATA')}> 
          <g id="DATA">
            <path className="st6" d="M593,127.9c13.5-16.1,27.6-31.6,43.6-45.3C686,40.3,742.8,14.1,807.2,4.7c32.2-4.6,64.9-4.5,97.1,0.2
            ...
            <path className="st1" d="M666.7,211.8L654.2,228L612.7,196l12.5-16.2c10.1-13.1,26-15.2,37.7-6.2l0.1,0.1
            ...
            <path className="st1" d="M713.1,155.8l-12-4.1l-14.6,16.7l5.7,11.4l-7.8,8.9l-25-51.7l7-8l54.6,17.9L713.1,155.8z M673.3,142.2
		          l8.2,16.5l9.2-10.5L673.3,142.2z"/>
            <path className="st1" d="M708.9,100.2l29.5,29.7l-8.2,8.1l-29.5-29.7l-11.3,11.3l-7.5-7.6l30.8-30.7l7.5,7.6L708.9,100.2z"/>
            <path className="st1" d="M780.5,93.1L769.3,87l-17.2,14l3.7,12.2l-9.1,7.4l-16-55.2l8.2-6.7l50.9,26.7L780.5,93.1z M743.5,72.9
		          l5.4,17.6l10.8-8.8L743.5,72.9z"/>
          </g>
        </a>
        
        <a onClick={() => this.changeActiveElement('IA')}> 
          <g id="IA">
            <path className="st7" d="M592.7,127.7c-15.8,20.7-29.6,42.5-40.5,66.2c-14.8,32.2-24.5,66.5-28.5,101.7c-0.9,7.7-0.5,15.5-2.6,23.1
            ...
            <path className="st1" d="M454.8,129.1l25.4-46l10.1,5.6l-25.3,46L454.8,129.1z"/>
            <path className="st1" d="M505.7,163.8l3.5-12.2l-17.5-13.7l-11,6.3l-9.3-7.3l50.3-27.7l8.4,6.6l-15,55.5L505.7,163.8z M517.3,123.2
		          l-16,9.1l11,8.6L517.3,123.2z"/>
          </g>
        </a> 

        <a onClick={() => this.changeActiveElement('DEV')}> 
          <g id="DEV">
            <path className="st8" d="M340.3,0c-6.7,17.3-13.1,33.9-19.5,50.4c-2.3,6-4.6,12.1-7.1,18.1c-1,2.4-1,5.2,0.1,7.6
            ...
            <path className="st1" d="M140.1,213.7l-10.4,17.6l-45.2-26.7l10.4-17.6c8.4-14.2,23.9-18.3,36.7-10.8l0.1,0.1
            ...
            <path className="st1" d="M159.1,184.1l-37.7-36.6l27.6-28.4l7.4,7.2l-19.6,20.2l7.6,7.4l17.2-17.8l7.4,7.2L151.8,161l7.9,7.7
				      l19.9-20.4l7.4,7.2L159.1,184.1z"/>
            <path className="st1" d="M215.9,138.4l-8.9,4.9l-44-36.1l11.2-6.1l29.8,25.8l-5.8-39l10.9-6L215.9,138.4z"/>
          </g>
        </a>
      </svg>
    );
